...
/**
 * @author fanshuhua
 * @date 2025/7/29 15:24
 */
@EqualsAndHashCode(callSuper = true)
@Data
@Accessors(chain = true)
public final class ParameterStruct extends ParameterProxy {
    ...
    public ParameterStruct(ValueType cValueType, ValueType pValueType, Name name, String qualifiers) {
