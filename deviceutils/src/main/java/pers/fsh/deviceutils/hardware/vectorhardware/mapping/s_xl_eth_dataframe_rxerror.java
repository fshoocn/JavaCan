 ...
 */
public class s_xl_eth_dataframe_rxerror extends Structure {
    /**
    ...
    public s_xl_eth_dataframe_rxerror() {
        super(1);
    }

    protected List<String> getFieldOrder() {
        return Arrays.asList("frameIdentifier", "frameDuration", "errorFlags", "dataLen", "reserved", "reserved2", "fcs", "destMAC", "sourceMAC", "frameData");
    }

    public static class ByReference extends s_xl_eth_dataframe_rxerror implements Structure.ByReference {

    }

    ;

    public static class ByValue extends s_xl_eth_dataframe_rxerror implements Structure.ByValue {
